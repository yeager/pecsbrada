...
from pecsbrada.accessibility import AccessibilityManager
...
class PecsbradaApp(Adw.Application):
    ...
    def _on_about(self, *_args):
        about = Adw.AboutDialog(
            ...
            debug_info=f"TTS: {__import__('pecsbrada.tts', fromlist=['get_tts_info']).get_tts_info()}\n"
        ...
        about.add_link(_("Help translate"), "https://app.transifex.com/danielnylander/pecsbrada")
